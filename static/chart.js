...
function buildCharts(sample) {
    ...
    d3.json("samples.json").then((data) => {
        ...
        var gaugeData = [{
            ...
            gauge: {
                axis: {
                    range: [0, 10], // ADD 0 AND 10 MARKERS
                    tickwidth: 1,
                    tickcolor: "black"
                },
                bar: { color: "black" },
                steps: [
                    { range: [0, 2], color: "rgb(228, 97, 97)" },
                    { range: [2, 4], color: "rgb(241, 185, 99)" },
                    { range: [4, 6], color: "rgb(248, 243, 152)" },
                    { range: [6, 8], color: "rgb(203, 240, 120)" },
                    { range: [8, 10], color: "rgb(167, 222, 241)" }
                ]
            }
        }];
